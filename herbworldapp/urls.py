...
urlpatterns = [
    ...
    path("nursery-search/", views.nurserySearch, name="nurserySearch"),
    ...
    path("manageorders/confirmorder", views.cancelOrder, name="confirmOrder"),
    ...
    path("manageproducts/updateproduct",
